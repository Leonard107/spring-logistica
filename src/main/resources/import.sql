...
insert into cidade (id, nome, estado_id) values (1, 'Ouro preto', 1);
insert into cidade (id, nome, estado_id) values (2, 'Tiradentes', 1);
insert into cidade (id, nome, estado_id) values (3, 'São Paulo', 2);
insert into cidade (id, nome, estado_id) values (4, 'Jundiai', 2);
insert into cidade (id, nome, estado_id) values (5, 'Sobral', 3);
